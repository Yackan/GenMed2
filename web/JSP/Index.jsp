...
<div class="jumbotron text-center" style="margin-bottom:0">
  ...
  <div class="w3-section">
    ...
    <i class="fa fa-deviantart w3-hover-opacity"></i>
  </div>
  <p class="w3-medium">Powered by <a href="https://www.deviantart.com/panther-dyams" target="_blank" class="w3-hover-text-green">Dyams-Yackan</a></p>
</footer>
</div>
